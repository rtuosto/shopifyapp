                    ...
                    <div className="flex items-start justify-between gap-4">
                      <div className="space-y-1 flex-1">
                        <div className="flex items-center gap-2 flex-wrap">
                          ...
                          <Badge
                            variant={
                              test.status === "draft" ? "secondary" : "default"
                            }
                        ...
                        <CardDescription
                          data-testid={`text-test-type-${index}`}
                        >
                      ...
                      {test.status === "draft" ? (
                        ...
                        >
                          ...
                          {activateTestMutation.isPending
                            ? "Activating..."
                            : "Activate Test"}
                        </Button>
                      ) : (
                        ...
                        {test.bayesianConfig &&
                          typeof test.bayesianConfig === "object" && (
                            <>
                              <div className="space-y-2">
                                <p className="text-xs text-muted-foreground">
                                  Variant Win Probability
                                </p>
                                <p className="text-2xl font-bold text-primary">
                                  {(() => {
                                    const config = test.bayesianConfig as any;
                                    const prob =
                                      config.probVariantBetter || 0.5;
                            ...
                            shouldPromote && (
                              <div className="flex items-center gap-2 p-3 bg-green-50 dark:bg-green-950 border border-green-200 dark:border-green-800 rounded-lg">
                                ...
                                <p className="text-sm text-green-700 dark:text-green-300 font-semibold">
                                  Ready for promotion - Variant significantly
                                  outperforms control
                                </p>
                              </div>
                            )
